...
var core = require('./core'); //Получаем йопту из скрипта
...
function yoptaToJs(scriptNode) {
  ...
  var yoptaText = scriptNode.textContent || getTxtFromSrc(scriptNode); //удаляем старый скрипт

  scriptNode.parentNode.removeChild(scriptNode); //создаём обработанный скрипт с блекджеком и шлюхами
...
var dictionary = require('./dictionary/main');
...
function compile(text, lang) {
  ...
  text = iterateText(text, lang); // comeback comments
...
function iterateText(text) {
  var to = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'js';
  var lang = LANGS[to];
  dictionary.sort(function (a, b) {
    ...
    return text = yoptReplaceAll(text, pair[lang], pair[+!lang]);
  });
  return text;
}

},{"./dictionary/main":3}],3:[function(require,module,exports){
"use strict";
