...
var dictionary = [
			...
			, ["continue", "двигай"]
			, ["debugger", "логопед"]
    // а default для switch-case будет "пахану"? хуита.
 , ["default", "апохуй"]
    // теперь switch case ащще чётенько будет естьчо: аеслинайду харэ - аеслинайду харэ - апохуй харэ
			, ["delete", "ёбнуть"]
			, ["delete", "ебнуть"]
			, ["do", "крч"]
			, ["else", "иливжопураз"]
...
//             Document methods
            ...
            , ["createDocumentFragment", "намутитьКсивыКусок"]
            ...
            , ["elementFromPoint", "лошокИзПараши"]
            , ["elementsFromPoint", "лошкиИзПараши"]
            , ["enableStyleSheetsForSet", "намутитьСтруйкуДляХабара"]
            , ["getAnimations", "вычислитьДвижуху"]
            , ["getElementsByClassName", "вычислитьЛошковПоКлассу"]
            , ["getElementsByTagName", "вычислитьЛошковПоТегу"]
            , ["importNode", "влабазУзел"]
            , ["registerElement", "зашитьДело"]
            , ["releaseCapture", "зафотатьХуякХуяк"]
            , ["getElementById", "вычислитьЛошкаПоНомеру"]
            ...
            , ["getElementsByName", "вычислитьЛошковПоИмени"]
...
//            Document Properties
            ...
            , ["doctype", "типКсивы"]
            , ["documentElement", "ксиваЛоха"]
            , ["documentURI", "ксиваНаХате"]
            , ["domConfig", "чоткоДерзко"]
            , ["hidden", "кроить"]
            , ["inputEncoding", "эйтыэтоПиздиш"]
            , ["pointerLockElement", "тырколкуНаАнусЛоха"]
            , ["scrollingElement", "намазиЛошок"]
            , ["timeline", "всяЖиза"]
            , ["visibilityState", "мутныйСюжет"]
            , ["children", "пездюки"]
            , ["firstElementChild", "первыйПездюкЛоха"]
            , ["lastElementChild", "последнийПездюкЛоха"]
            , ["childElementCount", "моиЛоховскиеПездюки"]
            , ["activeElement", "активныйЛох"]
...
//            Node methods
            ...
            , ["compareDocumentPosition", "сравниСтатусКсивы"]
