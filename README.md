...
[![contributions welcome](https://img.shields.io/packagist/l/doctrine/orm.svg)](https://github.com/samgozman/YoptaScript/master/LICENSE.txt)
...
Все крупные изменения и нововведения вы можете отслеить в файле **[CHANGELOG.md](https://github.com/samgozman/YoptaScript/master/CHANGELOG.md)**.
